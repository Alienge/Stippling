...
private:
	...
	bool equalCurrColor(int r, int g, int b, int k);
	void changeColor(int r, int g, int b);
	void changeColor(int r, int g, int b, int k);
	...
	void drawBasicCircle(double xcentre, double ycentre, double radius, int red, int green, int blue, int k);
public:

	epswriter(std::string fileName, double minX, double minY, double maxX, double maxY);
	epswriter(std::string fileName, double minX, double minY, double maxX, double maxY, double flag);
	~epswriter();
	...
	void filledCircle(double xcentre, double ycentre, double radius, int red, int green, int blue, int k);
